      ...
      <div id="page-content-wrapper">
         ...
         <div class="container-fluid d-flex justify-content-center align-items-center flex-column col-12" style="height: 90vh;">
            <div class="card col-lg-">
               <h4 class="title">Datos del nuevo alumno</h4>
               <form method="post" action="registrar_admin_tool.php">
                  <div class="field">
                     ...
                     <input autocomplete="off" id="nombre_alumno" placeholder="Nombre" class="input-field" name="nombre_alumno" type="text" required>
                  </div>
                  <div class="field">
                     ...
                     <input autocomplete="off" id="username_alumno" placeholder="Nombre de usuario" class="input-field" name="username_alumno" type="text" required>
                  </div>
                  <div class="field">
                     ...
                     <input type="text" name="id_cargo" hidden value="3">
               ...
               if (isset($_SESSION["resultado"])) {
                  echo "<p class='text-white m-0'>Alumno registrado con éxito</p>";
                  unset($_SESSION["resultado"]);
               } else {
                  echo "<p class='text-white m-0'>Esperando para registrar...</p>";
               }
               ?>
            </div>
         </div>
