   ...
   <div class="d-flex" id="wrapper">
      ...
      <div id="page-content-wrapper">
         ...
         <div class="container-fluid d-flex justify-content-center align-items-center flex-column col-12" style="height: 90vh;">
            <h1 class="text-whit" style="color: #23488f;">Mis cursos registrados</h1>
            ...
            <div class="">
               <table class="table table-primary">
                  ...
                  <tbody>
                     ...
                     $code = "SELECT * FROM alumno_materia, alumnos, cursos WHERE alumno_materia.name_id = '$idAlumnoActual' AND alumnos.id_alumno = '$idAlumnoActual' AND alumno_materia.curso_id = cursos.id_curso";
